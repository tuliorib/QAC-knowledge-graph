...
class Metadata:
    ...
    relevance_score: int = 0  # New field for relevance/uniqueness score

class MetadataExtractor:
    """LLM-based metadata extractor with support for different strategies."""

    def __init__(self, model: str = "gpt-4-1106-preview", api_key: str = None):
        self.model = model
    ...
    def _build_general_prompt(self, content: str, context: Dict[str, Any] = None) -> str:
        ...
        14. relevance_score: A score from 0 to 10 indicating the relevance and uniqueness of this text chunk.
           - 0: Completely discardable, no relevant or unique information.
           - 1-4: Low relevance or uniqueness, but may contain some minor details.
           - 5: Moderate relevance or uniqueness, contains some useful information.
           - 6-9: High relevance or uniqueness, contains important or novel information.
           - 10: Extremely relevant or unique, contains critical or essential information.
           Note: If the chunk contains ANY information deemed relevant, essential, or unique, the score should be 5 or above.
